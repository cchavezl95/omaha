        ...
        <div className="h-full py-4 overflow-y-auto bg-slider dark:bg-gray-800">
            ...
            <ul className="space-y-2 font-medium mt-[40px]">
                {/* <li onClick={()=>{setIdVista(1)}}>
                    <div className="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-sliderSelect dark:hover:bg-gray-700 pl-[15%] mt-[25px] cursor-pointer">
